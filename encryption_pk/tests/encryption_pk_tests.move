...
module encryption_pk::encryption_pk_tests {
    ...
    fun test_encryption_pk() {
        ...
        {
            create_pk(x"b58cfc3b0f43d98e7dbe865af692577d52813cb62ef3c355215ec3be2a0355a1ae5da76dd3e626f8a60de1f4a8138dee", utf8(b"encryption key for x marketplace"), test_scenario::ctx(&mut test));
        };
    ...
    fun test_encryption_pk_invalid() {
        ...
        test_scenario::next_tx(&mut test, alice);
        {
            create_pk(x"0000", utf8(b"test"), test_scenario::ctx(&mut test));
        };
        test_scenario::end(test);
    }
}
